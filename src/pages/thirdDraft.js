        ...
        <section>
          ...
          <ul className="menu_items">
            ...
            <li>
              ...
              <br />
              smoked trout roe, dill, something crunchy
            </li>
            <li>
              <span className="title">Sugar Snap Peas</span>
              <br />
              mint, ricotta salata, roasted garlic, toasted sesame, miso
              dressing
            </li>
          </ul>
          ...
          <ul className="menu_items">
            ...
            <li>
              <span className="title">Shrimp Ceviche</span>
              <br />
              tomato, horseradish, lime, lettuce wraps
            </li>
            <li>
              <span className="title">Local Lettuces</span>
              <br />
              Maine crab, radish, celery, sour cherries, breadcrumbs, citrus
              vinaigrette
            </li>
          </ul>
        </section>
        <section>
          ...
          <ul className="menu_items">
            ...
            <li>
              ...
              <br />
              black rice, crushed cucumbers, green goddess
            </li>
            <li>
              <span className="title">Crispy Braised Pork Belly</span>
              <br />
              juniper, pickles, lime crema
            </li>
            <li>
              <span className="title">Steak Tartare</span>
              <br />
              traditional flavors, cured egg yolk, caviar, rye crisps
            </li>
            <li>
              <span className="title">Carrots</span>
              <br />
